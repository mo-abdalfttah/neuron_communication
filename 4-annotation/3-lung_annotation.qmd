...
params:
  title: "Neural Circuits - Annotation Lung Model"
format:
    html:
...
```{r, fig.width=5, echo=FALSE, message=FALSE, warning=FALSE, results='hide'}
...
se_obj@meta.data <- se_obj@meta.data %>%
  mutate(annotation_lvl1 = case_when(
    ...
    RNA_snn_res.0.2 == 1 ~ "Microglia",
    RNA_snn_res.0.2 == 2 ~ "Microglia",
    RNA_snn_res.0.2 == 3 ~ "Myeloid",
    RNA_snn_res.0.2 == 4 ~ "Oligodendrocytes",
    RNA_snn_res.0.2 == 5 ~ "Astrocytes",
    RNA_snn_res.0.2 == 6 ~ "Inhibitory neurons",
    RNA_snn_res.0.2 == 7 ~ "T Cells",
    RNA_snn_res.0.2 == 8 ~ "Epithelial",
    RNA_snn_res.0.2 == 9 ~ "OPCs",
    RNA_snn_res.0.2 == 10 ~ "NK Cells",
    RNA_snn_res.0.2 == 11 ~ "Endothelial",
    RNA_snn_res.0.2 == 12 ~ "Mesenchymal"
...
genes_multiple <- str_to_title(c("Gfap", "Aqp4", "Aldh1l1","Slc1a3", "S100b", # Astrocytes
                                 ...
                                 "Krt18", "Epcam", "Krt19", "Krt23", # Epithilial 
                                 ...
                                 "Cd14", "Psap", "S100a9", "Fcer1g", # Microglia
                                 "Ncr1", "Klra8", "Klri2", "Klrb1c", # NK

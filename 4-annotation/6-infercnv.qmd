...
infercnv_obj = CreateInfercnvObject(raw_counts_matrix=se_obj@assays$RNA$counts,
                                    ...
                                    ref_group_names=c("Excitatory neurons", "Inhibitory neurons", "Astrocytes", "Oligodendrocytes", "Endothelial", "Microglia"))
```

# Run InferCnv

```{r}
output <- "{path}/4-annotation/objects/infercnv_out/{model}_newref" %>%
  glue::glue() %>%
  here::here()
```

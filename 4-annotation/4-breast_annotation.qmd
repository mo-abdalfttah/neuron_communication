...
params:
  title: "Neural Circuits - Annotation Breast Model"
format:
    html:
...
se_obj@meta.data <- se_obj@meta.data %>%
  mutate(annotation_lvl1 = case_when(
    RNA_snn_res.0.2 == 0 ~ "Myeloid",
    RNA_snn_res.0.2 == 1 ~ "Excitatory neurons",
    RNA_snn_res.0.2 == 2 ~ "Epithelial ",
    RNA_snn_res.0.2 == 3 ~ "Myeloid",
    RNA_snn_res.0.2 == 4 ~ "Astrocytes",
    RNA_snn_res.0.2 == 5 ~ "Microglia",
    RNA_snn_res.0.2 == 6 ~ "Oligodendrocytes",
    RNA_snn_res.0.2 == 7 ~ "Myeloid",
    RNA_snn_res.0.2 == 8 ~ "T Cells",
    RNA_snn_res.0.2 == 9 ~ "NK Cells",
    RNA_snn_res.0.2 == 10 ~ "Inhibitory neurons",
    RNA_snn_res.0.2 == 11 ~ "Endothelial",
    RNA_snn_res.0.2 == 12 ~ "OPCs"
...
genes_multiple <- str_to_title(c("Gfap", "Aqp4", "Aldh1l1","Slc1a3", "S100b", # Astrocytes
                                 ...
                                 "Krt8", "Krt20", "Mmp10", "Mki67", "Top2a", # Epithilial 

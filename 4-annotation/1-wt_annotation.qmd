...
se_obj@meta.data <- se_obj@meta.data %>%
  mutate(annotation_lvl1 = case_when(
    ...
    RNA_snn_res.0.2 == 2 ~ "Excitatory neurons",
    RNA_snn_res.0.2 == 3 ~ "Astrocytes",
    RNA_snn_res.0.2 == 4 ~ "Inhibitory neurons",
    RNA_snn_res.0.2 == 5 ~ "Inhibitory neurons",
    RNA_snn_res.0.2 == 6 ~ "Microglia",
    RNA_snn_res.0.2 == 7 ~ "Oligodendrocytes",
    RNA_snn_res.0.2 == 8 ~ "Endothelial",
    RNA_snn_res.0.2 == 9 ~ "OPCs",
    RNA_snn_res.0.2 == 10 ~ "Prolifrative Cells",
    RNA_snn_res.0.2 == 11 ~ "Excitatory neurons",
